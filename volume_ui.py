...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_volume_volfileBrowse.setIcon(icon)
        ...
        self.gridLayout_volume_menu.addWidget(self.horizontalSlider_volume_threshold, 1, 5, 1, 2)
        ...
        self.pushButton_volume_configfileBrowse.setIcon(icon)
        ...
        self.pushButton_volume_seqfileBrowse.setIcon(icon)
        ...
        self.pushButton_volume_seqfileClear.setIcon(icon1)
        ...
        self.pushButton_volume_outputdirClear.setIcon(icon1)
        ...
        self.pushButton_volume_configfileClear.setIcon(icon1)
